...
def create_app():
    ...
    from app.routes.mirror_api import mirror_bp
    from app.models import Announcement, ABTest, ABTestAssignment, Mirror, FileReplica  # Ensure models are registered
